...
// Attributes
	...
	_CSTRING_NS::CString GetItemText(int nItem, int nSubItem) const
	{
		_CSTRING_NS::CString strText;
...
// Operations
	...
	{
		LVCOLUMN column = { 0 };
		column.mask = LVCF_TEXT | LVCF_FMT | LVCF_MINWIDTH;
