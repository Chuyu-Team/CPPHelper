...
class CString
{
#define ReleaseBufferSetLength  ReleaseBuffer
public:
// Constructors
	CString()
	{
...
// Attributes & Operations
	...
	void Append(LPCTSTR Str, int cchStr=-1)
	{
		auto Length = GetData()->nDataLength;
		memcpy(GetBufferSetLength(Length + cchStr) + Length, Str, (cchStr != -1 ? cchStr : _tcslen(Str))*sizeof(TCHAR));
	}
