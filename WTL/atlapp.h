...
#else
#define IsThemeAvailable() (IsThemeActive() && IsAppThemed())
#endif
...
#else
#define SizeOf_REBARBANDINFO() sizeof(REBARBANDINFO)
#endif
...
#else
#define SizeOf_LVGROUP() sizeof(LVGROUP)
#endif
...
#else
#define SizeOf_LVTILEINFO() sizeof(LVTILEINFO)
#endif
...
#else
#define SizeOf_MCHITTESTINFO() sizeof(MCHITTESTINFO)
#endif
...
#else
#define SizeOf_NONCLIENTMETRICS() sizeof(NONCLIENTMETRICS)
#endif
...
#else
#define SizeOf_TOOLINFO() sizeof(TOOLINFO)
#endif
#endif // !_WIN32_WCE
//};
